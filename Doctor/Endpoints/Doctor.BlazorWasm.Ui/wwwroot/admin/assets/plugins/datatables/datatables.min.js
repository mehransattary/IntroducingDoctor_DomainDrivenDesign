...
oPaginate:{sFirst:"ابتدا",sLast:"انتها",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"No data available in table",sInfo:"نمایش _START_ از _END_ تا _TOTAL_ داده",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ داده",sLoadingRecords:"بارگذاری...",sProcessing:"در حال پردازش...",sSearch:"جستجو کردن:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"داده ای یافت نشد"},oSearch:h.extend({},
